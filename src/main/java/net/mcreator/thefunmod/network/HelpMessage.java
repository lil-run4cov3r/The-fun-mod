...
import net.mcreator.thefunmod.procedures.EOnKeyPressedProcedure;
...
public class HelpMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			EOnKeyPressedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheFunModMod.addNetworkMessage(HelpMessage.class, HelpMessage::buffer, HelpMessage::new, HelpMessage::handler);
	}
}
